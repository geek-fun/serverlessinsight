...
import { createResource, deleteResource, updateResource } from './tosResource';
...
const executeCreateAction = async (
  ...
  const newState = await createResource(context, bucket, currentState);
...
const executeUpdateAction = async (
  ...
  const newState = await updateResource(context, bucket, currentState);
...
const executeDeleteAction = async (
  ...
  const newState = await deleteResource(context, bucketName, logicalId, currentState);

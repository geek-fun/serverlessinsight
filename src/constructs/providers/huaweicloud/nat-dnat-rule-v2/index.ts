// https://registry.terraform.io/providers/huaweicloud/huaweicloud/1.71.1/docs/resources/nat_dnat_rule_v2
...
export interface NatDnatRuleV2Config extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/huaweicloud/1.71.1/docs/resources/nat_dnat_rule_v2#description NatDnatRuleV2#description}
  */
  readonly description?: string;
  /**
  * The port range used by Floating IP provide services for external systems.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/huaweicloud/1.71.1/docs/resources/nat_dnat_rule_v2#external_service_port NatDnatRuleV2#external_service_port}
  */
  readonly externalServicePort?: number;
  /**
  * The port range used by ECSs or BMSs to provide services for external systems.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/huaweicloud/1.71.1/docs/resources/nat_dnat_rule_v2#external_service_port_range NatDnatRuleV2#external_service_port_range}
  */
  readonly externalServicePortRange?: string;
  /**
  * The ID of the floating IP address.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/huaweicloud/1.71.1/docs/resources/nat_dnat_rule_v2#floating_ip_id NatDnatRuleV2#floating_ip_id}
  */
  readonly floatingIpId?: string;
  /**
  * The ID of the global EIP connected by the DNAT rule.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/huaweicloud/1.71.1/docs/resources/nat_dnat_rule_v2#global_eip_id NatDnatRuleV2#global_eip_id}
  */
  readonly globalEipId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/huaweicloud/1.71.1/docs/resources/nat_dnat_rule_v2#id NatDnatRuleV2#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/huaweicloud/1.71.1/docs/resources/nat_dnat_rule_v2#internal_service_port NatDnatRuleV2#internal_service_port}
  */
  readonly internalServicePort?: number;
  /**
  * The port used by ECSs or BMSs to provide services for external systems.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/huaweicloud/1.71.1/docs/resources/nat_dnat_rule_v2#internal_service_port_range NatDnatRuleV2#internal_service_port_range}
  */
  readonly internalServicePortRange?: string;
  /**
  * The ID of the NAT gateway to which the DNAT rule belongs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/huaweicloud/1.71.1/docs/resources/nat_dnat_rule_v2#nat_gateway_id NatDnatRuleV2#nat_gateway_id}
  */
  readonly natGatewayId: string;
  /**
  * The port ID of network.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/huaweicloud/1.71.1/docs/resources/nat_dnat_rule_v2#port_id NatDnatRuleV2#port_id}
  */
  readonly portId?: string;
  /**
  * The private IP address of a user.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/huaweicloud/1.71.1/docs/resources/nat_dnat_rule_v2#private_ip NatDnatRuleV2#private_ip}
  */
  readonly privateIp?: string;
  /**
  * The protocol type.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/huaweicloud/1.71.1/docs/resources/nat_dnat_rule_v2#protocol NatDnatRuleV2#protocol}
  */
  readonly protocol: string;
  /**
  * The region where the DNAT rule is located.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/huaweicloud/1.71.1/docs/resources/nat_dnat_rule_v2#region NatDnatRuleV2#region}
  */
  readonly region?: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/huaweicloud/1.71.1/docs/resources/nat_dnat_rule_v2#timeouts NatDnatRuleV2#timeouts}
  */
  readonly timeouts?: NatDnatRuleV2Timeouts;
}
export interface NatDnatRuleV2Timeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/huaweicloud/1.71.1/docs/resources/nat_dnat_rule_v2#create NatDnatRuleV2#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/huaweicloud/1.71.1/docs/resources/nat_dnat_rule_v2#delete NatDnatRuleV2#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/huaweicloud/1.71.1/docs/resources/nat_dnat_rule_v2#update NatDnatRuleV2#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/huaweicloud/huaweicloud/1.71.1/docs/resources/nat_dnat_rule_v2 huaweicloud_nat_dnat_rule_v2}
*/
export class NatDnatRuleV2 extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "huaweicloud_nat_dnat_rule_v2";
  ...
  * @param importFromId The id of the existing NatDnatRuleV2 that should be imported. Refer to the {@link https://registry.terraform.io/providers/huaweicloud/huaweicloud/1.71.1/docs/resources/nat_dnat_rule_v2#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the NatDnatRuleV2 to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "huaweicloud_nat_dnat_rule_v2", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/huaweicloud/huaweicloud/1.71.1/docs/resources/nat_dnat_rule_v2 huaweicloud_nat_dnat_rule_v2} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: NatDnatRuleV2Config) {
    super(scope, id, {
      terraformResourceType: 'huaweicloud_nat_dnat_rule_v2',

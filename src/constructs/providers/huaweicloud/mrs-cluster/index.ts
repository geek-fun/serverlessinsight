// https://registry.terraform.io/providers/huaweicloud/huaweicloud/1.71.1/docs/resources/mrs_cluster
...
export interface MrsClusterConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/huaweicloud/1.71.1/docs/resources/mrs_cluster#available_zone_id MrsCluster#available_zone_id}
  */
  readonly availableZoneId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/huaweicloud/1.71.1/docs/resources/mrs_cluster#billing_type MrsCluster#billing_type}
  */
  readonly billingType: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/huaweicloud/1.71.1/docs/resources/mrs_cluster#cluster_admin_secret MrsCluster#cluster_admin_secret}
  */
  readonly clusterAdminSecret: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/huaweicloud/1.71.1/docs/resources/mrs_cluster#cluster_name MrsCluster#cluster_name}
  */
  readonly clusterName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/huaweicloud/1.71.1/docs/resources/mrs_cluster#cluster_type MrsCluster#cluster_type}
  */
  readonly clusterType?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/huaweicloud/1.71.1/docs/resources/mrs_cluster#cluster_version MrsCluster#cluster_version}
  */
  readonly clusterVersion?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/huaweicloud/1.71.1/docs/resources/mrs_cluster#core_node_num MrsCluster#core_node_num}
  */
  readonly coreNodeNum: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/huaweicloud/1.71.1/docs/resources/mrs_cluster#core_node_size MrsCluster#core_node_size}
  */
  readonly coreNodeSize: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/huaweicloud/1.71.1/docs/resources/mrs_cluster#id MrsCluster#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/huaweicloud/1.71.1/docs/resources/mrs_cluster#log_collection MrsCluster#log_collection}
  */
  readonly logCollection?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/huaweicloud/1.71.1/docs/resources/mrs_cluster#master_node_num MrsCluster#master_node_num}
  */
  readonly masterNodeNum: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/huaweicloud/1.71.1/docs/resources/mrs_cluster#master_node_size MrsCluster#master_node_size}
  */
  readonly masterNodeSize: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/huaweicloud/1.71.1/docs/resources/mrs_cluster#node_password MrsCluster#node_password}
  */
  readonly nodePassword?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/huaweicloud/1.71.1/docs/resources/mrs_cluster#node_public_cert_name MrsCluster#node_public_cert_name}
  */
  readonly nodePublicCertName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/huaweicloud/1.71.1/docs/resources/mrs_cluster#region MrsCluster#region}
  */
  readonly region?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/huaweicloud/1.71.1/docs/resources/mrs_cluster#safe_mode MrsCluster#safe_mode}
  */
  readonly safeMode: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/huaweicloud/1.71.1/docs/resources/mrs_cluster#subnet_id MrsCluster#subnet_id}
  */
  readonly subnetId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/huaweicloud/1.71.1/docs/resources/mrs_cluster#tags MrsCluster#tags}
  */
  readonly tags?: { [key: string]: string };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/huaweicloud/1.71.1/docs/resources/mrs_cluster#volume_size MrsCluster#volume_size}
  */
  readonly volumeSize: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/huaweicloud/1.71.1/docs/resources/mrs_cluster#volume_type MrsCluster#volume_type}
  */
  readonly volumeType: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/huaweicloud/1.71.1/docs/resources/mrs_cluster#vpc_id MrsCluster#vpc_id}
  */
  readonly vpcId: string;
  /**
  * add_jobs block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/huaweicloud/1.71.1/docs/resources/mrs_cluster#add_jobs MrsCluster#add_jobs}
  */
  readonly addJobs?: MrsClusterAddJobs[] | cdktf.IResolvable;
  /**
  * component_list block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/huaweicloud/1.71.1/docs/resources/mrs_cluster#component_list MrsCluster#component_list}
  */
  readonly componentList: MrsClusterComponentListStruct[] | cdktf.IResolvable;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/huaweicloud/1.71.1/docs/resources/mrs_cluster#timeouts MrsCluster#timeouts}
  */
  readonly timeouts?: MrsClusterTimeouts;
}
export interface MrsClusterAddJobs {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/huaweicloud/1.71.1/docs/resources/mrs_cluster#arguments MrsCluster#arguments}
  */
  readonly arguments?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/huaweicloud/1.71.1/docs/resources/mrs_cluster#file_action MrsCluster#file_action}
  */
  readonly fileAction?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/huaweicloud/1.71.1/docs/resources/mrs_cluster#hive_script_path MrsCluster#hive_script_path}
  */
  readonly hiveScriptPath?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/huaweicloud/1.71.1/docs/resources/mrs_cluster#hql MrsCluster#hql}
  */
  readonly hql?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/huaweicloud/1.71.1/docs/resources/mrs_cluster#input MrsCluster#input}
  */
  readonly input?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/huaweicloud/1.71.1/docs/resources/mrs_cluster#jar_path MrsCluster#jar_path}
  */
  readonly jarPath: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/huaweicloud/1.71.1/docs/resources/mrs_cluster#job_log MrsCluster#job_log}
  */
  readonly jobLog?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/huaweicloud/1.71.1/docs/resources/mrs_cluster#job_name MrsCluster#job_name}
  */
  readonly jobName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/huaweicloud/1.71.1/docs/resources/mrs_cluster#job_type MrsCluster#job_type}
  */
  readonly jobType: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/huaweicloud/1.71.1/docs/resources/mrs_cluster#output MrsCluster#output}
  */
  readonly output?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/huaweicloud/1.71.1/docs/resources/mrs_cluster#shutdown_cluster MrsCluster#shutdown_cluster}
  */
  readonly shutdownCluster?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/huaweicloud/1.71.1/docs/resources/mrs_cluster#submit_job_once_cluster_run MrsCluster#submit_job_once_cluster_run}
  */
  readonly submitJobOnceClusterRun: boolean | cdktf.IResolvable;
}

export function mrsClusterAddJobsToTerraform(struct?: MrsClusterAddJobs | cdktf.IResolvable): any {
...
export function mrsClusterAddJobsToHclTerraform(struct?: MrsClusterAddJobs | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class MrsClusterAddJobsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): MrsClusterAddJobs | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: MrsClusterAddJobs | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class MrsClusterAddJobsList extends cdktf.ComplexList {
  public internalValue? : MrsClusterAddJobs[] | cdktf.IResolvable
  ...
  */
  public get(index: number): MrsClusterAddJobsOutputReference {
    return new MrsClusterAddJobsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface MrsClusterComponentListStruct {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/huaweicloud/1.71.1/docs/resources/mrs_cluster#component_name MrsCluster#component_name}
  */
  readonly componentName: string;
}

export function mrsClusterComponentListStructToTerraform(struct?: MrsClusterComponentListStruct | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function mrsClusterComponentListStructToHclTerraform(struct?: MrsClusterComponentListStruct | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class MrsClusterComponentListStructOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktf.IResolvable;
  ...
  */
  ...
  public get internalValue(): MrsClusterComponentListStruct | cdktf.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: MrsClusterComponentListStruct | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
...
export class MrsClusterComponentListStructList extends cdktf.ComplexList {
  public internalValue? : MrsClusterComponentListStruct[] | cdktf.IResolvable
  ...
  * @param index the index of the item to return
  */
  public get(index: number): MrsClusterComponentListStructOutputReference {
    return new MrsClusterComponentListStructOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface MrsClusterTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/huaweicloud/1.71.1/docs/resources/mrs_cluster#create MrsCluster#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/huaweicloud/1.71.1/docs/resources/mrs_cluster#delete MrsCluster#delete}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/huaweicloud/huaweicloud/1.71.1/docs/resources/mrs_cluster huaweicloud_mrs_cluster}
*/
export class MrsCluster extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "huaweicloud_mrs_cluster";
  ...
  * @param importFromId The id of the existing MrsCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/huaweicloud/huaweicloud/1.71.1/docs/resources/mrs_cluster#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the MrsCluster to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "huaweicloud_mrs_cluster", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/huaweicloud/huaweicloud/1.71.1/docs/resources/mrs_cluster huaweicloud_mrs_cluster} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: MrsClusterConfig) {
    super(scope, id, {
      terraformResourceType: 'huaweicloud_mrs_cluster',
  ...
  private _addJobs = new MrsClusterAddJobsList(this, "add_jobs", true);
  public get addJobs() {
    return this._addJobs;
  }
  public putAddJobs(value: MrsClusterAddJobs[] | cdktf.IResolvable) {
  ...
  private _componentList = new MrsClusterComponentListStructList(this, "component_list", true);
  public get componentList() {
    return this._componentList;
  }
  public putComponentList(value: MrsClusterComponentListStruct[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      add_jobs: cdktf.listMapper(mrsClusterAddJobsToTerraform, true)(this._addJobs.internalValue),
      component_list: cdktf.listMapper(mrsClusterComponentListStructToTerraform, true)(this._componentList.internalValue),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      add_jobs: {
        value: cdktf.listMapperHcl(mrsClusterAddJobsToHclTerraform, true)(this._addJobs.internalValue),
        isBlock: true,
        type: "set",
        storageClassType: "MrsClusterAddJobsList",
      },
      component_list: {
        value: cdktf.listMapperHcl(mrsClusterComponentListStructToHclTerraform, true)(this._componentList.internalValue),
        isBlock: true,
        type: "set",
        storageClassType: "MrsClusterComponentListStructList",
      },
      timeouts: {
